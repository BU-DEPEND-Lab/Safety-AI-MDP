...
unsafe = []
for s in range(S):
	if (int(s%coords[0]) <= (coords[0] -1) * 1/18 and int(s/coords[0]) <= (coords[1] -1 ) * 1/14) or (int(s%coords[0]) >= (coords[0] - 1) * 17/18 and int(s/coords[0]) >= (coords[1] - 1) * 13/14) or int(s/coords[0]) >= (coords[1] - 1) * 16/14: 
