		...
		while (diff > epsilon) {
			...
			for (int i = 0; i <= y_max; i++) {
				for (int j = 0; j <= x_max; j++) {
					...
					PrintStream ps_file = new PrintStream(new FileOutputStream(new File("//home/zekunzhou/workspace/Safety-AI-MDP/cirl/prism-4.3.1-src/src/demos/grid_good.pm")));
					System.setOut(ps_file);
					//System.out.println(mf_good);
					System.setOut(ps_console);
					//System.out.println(mf_good);
					ModulesFile mf = prism.parseModelFile(new File("//home/zekunzhou/workspace/Safety-AI-MDP/cirl/prism-4.3.1-src/src/demos/grid_good.pm"));
		...
		while (diff > epsilon) {
			...
			for (int i = 0; i <= y_max; i++) {
				for (int j = 0; j <= x_max; j++) {
					...
					mf_bad.tidyUp();
					PrintStream ps_console = System.out;
					PrintStream ps_file = new PrintStream(new FileOutputStream(new File("//home/zekunzhou/workspace/Safety-AI-MDP/cirl/prism-4.3.1-src/src/demos/grid_bad.pm")));
					System.setOut(ps_file);
					//System.out.println(mf_bad);
					System.setOut(ps_console);
					ModulesFile mf = prism.parseModelFile(new File("//home/zekunzhou/workspace/Safety-AI-MDP/cirl/prism-4.3.1-src/src/demos/grid_bad.pm"));
					prism.loadPRISMModel(mf);
