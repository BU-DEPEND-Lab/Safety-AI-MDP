...
public class grid_world {
		...
		while (diff > epsilon) {
			...
			for (int i = 0; i <= y_max; i++) {
				for (int j = 0; j <= x_max; j++) {
					...
					PrintStream ps_file = new PrintStream(new FileOutputStream(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_good.pm")));
					System.setOut(ps_file);
					System.out.println(mf_good);
					System.setOut(ps_console);
					//System.out.println(mf_good);
					ModulesFile mf = prism.parseModelFile(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_good.pm"));
		...
		while (diff > epsilon) {
			...
			for (int i = 0; i <= y_max; i++) {
				for (int j = 0; j <= x_max; j++) {
					...
					mf_bad.tidyUp();
					PrintStream ps_console = System.out;
					PrintStream ps_file = new PrintStream(new FileOutputStream(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_bad.pm")));
					System.setOut(ps_file);
					System.out.println(mf_bad);
					System.setOut(ps_console);
					ModulesFile mf = prism.parseModelFile(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_bad.pm"));
					prism.loadPRISMModel(mf);
	...
	static final public void check(Prism prism, ModulesFile mf_opt, Matrix P_OPT) throws FileNotFoundException, PrismException {
		prism.loadPRISMModel(mf_opt);

		PrintStream ps_console = System.out;
		PrintStream ps_file = new PrintStream(new FileOutputStream(
				new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_world.pm")));
		System.setOut(ps_file);
		...
		ModulesFile modulesFile = prism
				.parseModelFile(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_world.pm"));
		prism.loadPRISMModel(modulesFile);
		// Parse and load a properties model for the model
		PropertiesFile propertiesFile = prism.parsePropertiesFile(modulesFile,
				new File("/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/prism-4.3.1-src/src/demos/grid_world.pctl"));
		Result result = prism.modelCheck(propertiesFile, propertiesFile.getPropertyObject(0));
	...
	static final public void run() throws InterruptedException, FileNotFoundException {
		try {
			...
			String STATE_SPACE = "/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/cirl/state_space";
			String OPT_POLICY = "/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/cirl/optimal_policy";
			String DEMO_POLICY = "/Users/weichaozhou/Documents/Safe_AI_MDP/Safety-AI-MDP/cirl/demo_policy";
