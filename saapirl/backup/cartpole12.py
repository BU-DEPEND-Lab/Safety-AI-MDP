...
unsafe = []
for s in range(S):
	if (int(s%coords[0]) <= 0 and int(((s/coords[0])/coords[1])/coords[2])%coords[3] <=  0)  or (int(s%coords[0]) >= (coords[0] - 1 + 2) and int(((s/coords[0])/coords[1])/coords[2])%coords[3] >= coords[1] - 1):
